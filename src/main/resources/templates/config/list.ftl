...
<head>
    ...
    <script type="text/javascript" src="/config/js/list.js"></script>
            ...
            <div class="layui-card">
                <div class="layui-card-body">
                    ...
                    <div class="layui-form ">
                        <table class="layui-table" id="SysConfigTable" cyType="pageGrid"
                               cyProps="url:'/sys/config/listData',checkbox:'true',pageColor:'#2991d9'">
                            <thead>
                            <tr>
                                <!--复选框-->
