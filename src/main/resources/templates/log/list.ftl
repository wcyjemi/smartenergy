...
<head>
    ...
    <script type="text/javascript" src="/log/js/list.js"></script>
...
<div class="layui-fluid">
    ...
    <div class="layui-form ">
        <table class="layui-table" id="syslogTable" cyType="pageGrid"
               cyProps="url:'/sys/log/listData',checkbox:'true',pageColor:'#2991d9',pageSize:10">
            <thead>
            <tr>
                <!--复选框-->
