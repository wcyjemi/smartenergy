        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-normal">
                <input id="visitTime" type="text" name="visitTime" maxlength="20" lay-verify="required"
                       value="${(model.visitTime?string("yyyy-MM-dd"))}" placeholder="请输入回访时间" class="layui-input">
            </div>
        </div>
       <#include "common.ftl"/>
        ...
        <div class="page-footer">
            <div class="btn-list">
                <div class="btnlist">
                    <button class="layui-btn" lay-submit="" lay-filter="layersubmit" data-url="/encompanyvisit/update"><i class="fa fa-floppy-o">&nbsp;</i>保存</button>
