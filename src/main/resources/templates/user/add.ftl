...
<div class="layui-field-box">
    <form class="layui-form" action="">
        ...
        <div class="layui-form-item">
            ...
            <input type="hidden" value="" name="companyIdsStr" id="companyIdsStr">
            <div cyType="selectTool" cyProps="url:'/encompany/queryAll',multiple:'true'"
                 value="" name="companyIds[]" class="layui-input-normal"></div>
        </div>
        <div class="layui-form-item">
