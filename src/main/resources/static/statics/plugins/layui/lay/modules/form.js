                    ...
                    dds.on('click', function(event){
                        ...
                        if(typeof select.attr('multiple') && typeof select.attr('multiple') === 'string'){
                            ...
                            if(othis.find("input[type='checkbox']").is(':checked')){
                                multiSelect.html(multiSelect.html() + "<a href='javascript:;'><span>"+othis.find("span").text()+"</span></a>");
                                              ...
                                              for(var option=0;option<options.length;option++){
                                                 var _value= $(options[option]).attr('value');
                                                  if(_value==value[aList]){
                                                      aLists.push("<a href='javascript:;'><span>"+$(options[option]).text()+"</span></a>");
                                                  }
                                        ...
                                        if(value != null && value != undefined && value.length != 0) {
                                            ...
                                            for (var checkedVal = 0; checkedVal < value.length; checkedVal++) {
                                                if (value[checkedVal] == item.value) {
                                                    arr.push('<dd lay-value="' + item.value + '">' + '<input type="checkbox" ' + (item.disabled ? "disabled" : "") + ' checked lay-filter="searchChecked" title="' + item.innerHTML + '" value="'+item.value+'" name="'+$(item).attr('dataname')+'" lay-skin="primary"></dd>');
                                                    return false;
                                                }
                                            }
                                        }
                                        arr.push('<dd lay-value="' + item.value + '">' + '<input type="checkbox" ' + (item.disabled ? "disabled" : "") + ' lay-filter="searchChecked" title="' + item.innerHTML + '" value="'+item.value+'" name="'+$(item).attr('dataname')+'"  lay-skin="primary"></dd>');
                                    }
                                });
